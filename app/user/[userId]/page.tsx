...
import { Link, LinkIcon, MapPin } from "lucide-react";
                ...
                <header className="bg-primary-foreground p-6 rounded-xl flex flex-col sm:flex-row items-center gap-6">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <div className="flex items-center justify-center sm:justify-start gap-6 mt-4 text-sm text-gray-400">
                            {user.contact && (
                                <a href={user.contact} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-cyan-400 transition-colors">
                                    <LinkIcon size={16} />
                                    <span>Contacto</span>
                                </a>
                            )}
                            <Link href="/map" className="flex items-center gap-2 hover:text-cyan-400 transition-colors">
                                <MapPin size={16} />
